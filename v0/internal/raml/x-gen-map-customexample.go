...
func NewCustomExampleMap(log *logrus.Entry) *CustomExampleMap {
	return &CustomExampleMap{
		log:   xlog.WithType(log, "internal.CustomExampleMap"),
...
func (o *CustomExampleMap) At(index uint) (key option.String, value raml.CustomExample) {
	...
	value = tmp.Value.(raml.CustomExample)
...
func (o *CustomExampleMap) UnmarshalRAML(val interface{}, log *logrus.Entry) (err error) {
	log.Trace("internal.CustomExampleMap.UnmarshalRAML")
