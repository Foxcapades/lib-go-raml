...
func NewStringExampleMap(log *logrus.Entry) *StringExampleMap {
	return &StringExampleMap{
		log:   xlog.WithType(log, "internal.StringExampleMap"),
...
func (o *StringExampleMap) At(index uint) (key option.String, value raml.StringExample) {
	...
	value = tmp.Value.(raml.StringExample)
...
func (o *StringExampleMap) UnmarshalRAML(val interface{}, log *logrus.Entry) (err error) {
	log.Trace("internal.StringExampleMap.UnmarshalRAML")
