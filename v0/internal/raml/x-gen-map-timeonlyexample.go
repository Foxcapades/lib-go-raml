...
func NewTimeOnlyExampleMap(log *logrus.Entry) *TimeOnlyExampleMap {
	return &TimeOnlyExampleMap{
		log:   xlog.WithType(log, "internal.TimeOnlyExampleMap"),
...
func (o *TimeOnlyExampleMap) At(index uint) (key option.String, value raml.TimeOnlyExample) {
	...
	value = tmp.Value.(raml.TimeOnlyExample)
...
func (o *TimeOnlyExampleMap) UnmarshalRAML(val interface{}, log *logrus.Entry) (err error) {
	log.Trace("internal.TimeOnlyExampleMap.UnmarshalRAML")
