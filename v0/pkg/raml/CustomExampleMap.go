...
// CustomExampleMap defines an ordered map of string to CustomExample.
type CustomExampleMap interface {
	...
	Put(k string, v CustomExample) CustomExampleMap
	...
	// Put.
	PutIfNotNil(k string, v *CustomExample) CustomExampleMap

	// ReplaceOrPut either replaces the existing entry keyed at `k` without
	// changing the map ordering or appends the given key/value pair to the end of
	// the map if no entry with the key `k` exists.
	ReplaceOrPut(k string, v CustomExample) CustomExampleMap
	...
	// nothing.
	ReplaceIfExists(k string, v CustomExample) CustomExampleMap
	...
	// in the map.
	At(i int) CustomExampleMapEntry
	...
	Delete(k string) CustomExampleMap
...
// CustomExampleMap.
type CustomExampleMapEntry struct {
	Key string        `json:"key"`
	Val CustomExample `json:"value"`
}

// NewCustomExampleMap creates a new instance of CustomExampleMap presized to the
// given size.
...
func (i *implCustomExampleMap) Put(k string, v CustomExample) CustomExampleMap {
	i.Delete(k)
	i.index[k] = v
	i.ordered = append(i.ordered, CustomExampleMapEntry{k, v})
	return i
}

func (i *implCustomExampleMap) PutIfNotNil(k string, v *CustomExample) CustomExampleMap {
	if !gomp.IsNil(v) {
		return i.Put(k, *v)
	}
...
func (i *implCustomExampleMap) ReplaceOrPut(k string, v CustomExample) CustomExampleMap {
	if i.Has(k) {
...
func (i *implCustomExampleMap) ReplaceIfExists(k string, v CustomExample) CustomExampleMap {
	pos := i.IndexOf(k)
...
func (i *implCustomExampleMap) Get(k string) (value CustomExample, exists bool) {
	v, ok := i.index[k]
	return v, ok
}
...
func (i *implCustomExampleMap) Len() int {
	return len(i.ordered)
}

func (i *implCustomExampleMap) Has(k string) bool {
	_, ok := i.index[k]
	return ok
}

func (i *implCustomExampleMap) IndexOf(k string) int {
...
func (i *implCustomExampleMap) Delete(k string) CustomExampleMap {
	pos := i.IndexOf(k)
...
func (i *implCustomExampleMap) ForEach(f func(k string, v CustomExample)) CustomExampleMap {
	for j := range i.ordered {
