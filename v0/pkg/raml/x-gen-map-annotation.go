...
// AnnotationMap generated @ 2020-05-20T20:54:25.054891636-04:00
type AnnotationMap interface {
	...
	Put(key string, value Annotation) AnnotationMap

	PutNonNil(key string, value Annotation) AnnotationMap
	...
	Replace(key string, value Annotation) Annotation
	...
	// map.
	At(index uint) (key option.String, value Annotation)
	...
	Delete(key string) Annotation

	ForEach(fn func(k string, v Annotation))
}
