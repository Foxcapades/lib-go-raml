...
// ArrayExampleMap generated @ 2020-05-20T20:54:25.054891636-04:00
type ArrayExampleMap interface {
	...
	Put(key string, value ArrayExample) ArrayExampleMap

	PutNonNil(key string, value ArrayExample) ArrayExampleMap
	...
	Replace(key string, value ArrayExample) ArrayExample
	...
	// map.
	At(index uint) (key option.String, value ArrayExample)
	...
	Delete(key string) ArrayExample

	ForEach(fn func(k string, v ArrayExample))
}
