...
// BoolExampleMap generated @ 2020-05-22T11:24:08.538522822-04:00
type BoolExampleMap interface {
	...
	Put(key string, value BoolExample) BoolExampleMap

	PutNonNil(key string, value BoolExample) BoolExampleMap
	...
	Replace(key string, value BoolExample) BoolExample
	...
	// map.
	At(index uint) (key option.String, value BoolExample)
	...
	Delete(key string) BoolExample

	ForEach(fn func(k string, v BoolExample))
}
