...
// CustomExampleMap generated @ 2020-05-20T21:46:00.242352937-04:00
type CustomExampleMap interface {
	...
	Put(key string, value CustomExample) CustomExampleMap

	PutNonNil(key string, value CustomExample) CustomExampleMap
	...
	Replace(key string, value CustomExample) CustomExample
	...
	// map.
	At(index uint) (key option.String, value CustomExample)
	...
	Delete(key string) CustomExample

	ForEach(fn func(k string, v CustomExample))
}
