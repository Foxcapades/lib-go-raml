...
// DatetimeOnlyExampleMap generated @ 2020-05-22T11:24:08.538522822-04:00
type DatetimeOnlyExampleMap interface {
	...
	Put(key string, value DatetimeOnlyExample) DatetimeOnlyExampleMap

	PutNonNil(key string, value DatetimeOnlyExample) DatetimeOnlyExampleMap
	...
	Replace(key string, value DatetimeOnlyExample) DatetimeOnlyExample
	...
	// This method returns the value previously stored at
	// `key` if such a value existed.
	ReplaceOrPut(key string, value DatetimeOnlyExample) DatetimeOnlyExample

	// Get returns the value stored at the given key (if it
	// exists) or nil if no such key was found.
	Get(key string) DatetimeOnlyExample
	...
	// map.
	At(index uint) (key option.String, value DatetimeOnlyExample)
	...
	Delete(key string) DatetimeOnlyExample

	ForEach(fn func(k string, v DatetimeOnlyExample))
}
