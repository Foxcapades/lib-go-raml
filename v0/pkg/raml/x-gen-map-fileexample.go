...
// FileExampleMap generated @ 2020-05-22T11:24:08.538522822-04:00
type FileExampleMap interface {
	...
	Put(key string, value FileExample) FileExampleMap

	PutNonNil(key string, value FileExample) FileExampleMap
	...
	Replace(key string, value FileExample) FileExample
	...
	// map.
	At(index uint) (key option.String, value FileExample)
	...
	Delete(key string) FileExample

	ForEach(fn func(k string, v FileExample))
}
