...
// IntegerExampleMap generated @ 2020-05-22T11:24:08.538522822-04:00
type IntegerExampleMap interface {
	...
	Put(key string, value IntegerExample) IntegerExampleMap

	PutNonNil(key string, value IntegerExample) IntegerExampleMap
	...
	Replace(key string, value IntegerExample) IntegerExample
	...
	// map.
	At(index uint) (key option.String, value IntegerExample)
	...
	Delete(key string) IntegerExample

	ForEach(fn func(k string, v IntegerExample))
}
