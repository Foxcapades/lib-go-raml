...
// ObjectExampleMap generated @ 2020-05-20T20:54:25.054891636-04:00
type ObjectExampleMap interface {
	...
	Put(key string, value ObjectExample) ObjectExampleMap

	PutNonNil(key string, value ObjectExample) ObjectExampleMap
	...
	Replace(key string, value ObjectExample) ObjectExample
	...
	// map.
	At(index uint) (key option.String, value ObjectExample)
	...
	Delete(key string) ObjectExample

	ForEach(fn func(k string, v ObjectExample))
}
