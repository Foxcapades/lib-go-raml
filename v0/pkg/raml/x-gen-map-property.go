...
// PropertyMap generated @ 2020-05-20T21:46:00.242352937-04:00
type PropertyMap interface {
	...
	Put(key string, value Property) PropertyMap

	PutNonNil(key string, value Property) PropertyMap
	...
	Replace(key string, value Property) Property
	...
	// This method returns the value previously stored at
	// `key` if such a value existed.
	ReplaceOrPut(key string, value Property) Property
	...
	// map.
	At(index uint) (key option.String, value Property)
	...
	Delete(key string) Property

	ForEach(fn func(k string, v Property))
}
