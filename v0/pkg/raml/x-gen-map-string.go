...
// StringMap generated @ 2020-05-22T11:24:08.538522822-04:00
type StringMap interface {
	...
	Put(key string, value string) StringMap

	PutNonNil(key string, value *string) StringMap
	...
	// existed.
	Replace(key string, value string) option.String
	...
	// value previously stored at `key` if such a value
	// existed.
	ReplaceOrPut(key string, value string) option.String
	...
	// map.
	At(index uint) (key option.String, value option.String)
	...
	// existed.
	Delete(key string) option.String

	ForEach(fn func(k string, v string))
}
