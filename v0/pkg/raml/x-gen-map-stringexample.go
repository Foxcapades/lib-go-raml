...
// StringExampleMap generated @ 2020-05-20T20:54:25.054891636-04:00
type StringExampleMap interface {
	...
	Put(key string, value StringExample) StringExampleMap

	PutNonNil(key string, value StringExample) StringExampleMap
	...
	Replace(key string, value StringExample) StringExample
	...
	// map.
	At(index uint) (key option.String, value StringExample)
	...
	Delete(key string) StringExample

	ForEach(fn func(k string, v StringExample))
}
