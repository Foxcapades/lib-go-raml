...
// UnionExampleMap generated @ 2020-05-22T11:24:08.538522822-04:00
type UnionExampleMap interface {
	...
	Put(key string, value UnionExample) UnionExampleMap

	PutNonNil(key string, value UnionExample) UnionExampleMap
	...
	Replace(key string, value UnionExample) UnionExample
	...
	// map.
	At(index uint) (key option.String, value UnionExample)
	...
	Delete(key string) UnionExample

	ForEach(fn func(k string, v UnionExample))
}
